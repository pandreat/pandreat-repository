<?php
	// General
	$moxieManagerConfig['general.license'] = 'KTKW-GFB2-XPKB-6PAM-6RYU-HNGV-AGPD-TAVL';
	$moxieManagerConfig['general.hidden_tools'] = '';
	$moxieManagerConfig['general.disabled_tools'] = '';
	$moxieManagerConfig['general.plugins'] = 'AmazonS3,AutoFormat,AutoRename';
	...
	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = '';//s3://scapi-dev';
	...
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,pdf,mp4';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "MetricsMedicus", "password" => "simcommand", "groups" => array("administrator"))
	);
...
/*
		'scapi-dev' => array(
			'publickey' => 'AKIAIZZMIPSFLUSUJEKQ',
			'secretkey' => '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'
		)
*/
	);
